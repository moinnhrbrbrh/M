...
from pwntools import asm, context
    ...
    try:
        ...
        if data.startswith(b'\x7fELF'):
            with open(file_path, 'rb') as f:
                ...
                result.append(f"🏷 *ARCHITECTURE:* {header['e_machine']} ({'x86_64' if header['e_machine'] == 62 else 'ARM' if header['e_machine'] == 40 else 'Unknown'})")
